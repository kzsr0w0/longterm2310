...
- [長期コース半年間の歩み](#長期コース半年間の歩み)
  ...
  - [2023-10-12 第4回 統計的仮説検定](#2023-10-12-第4回-統計的仮説検定)
...
- 【講義】Pythonの基礎
  - PythonとExcelの違い
  - Google Colabolatoryを使ってみる
- グループワーク「自己紹介、Pandas100本ノック」
...
## 2023-10-12 第4回 統計的仮説検定
- 「情報を得られるものは、情報を与えようとするものだけ」
- 「知識はコピペできても、経験はコピペできない」
- 【講義】統計的仮説検定
  - 対応のあるデータと対応のないデータ
  - 等分散と不等分散
  - P値
- グループワーク
- 統計的仮説検定のわかりやすいサイト
[1] [青木繁伸教授のサイト](http://aoki2.si.gunma-u.ac.jp/index.html)
[2] [ハンバーガー統計学にようこそ！](http://kogolab.chillout.jp/elearn/hamburger/)
[3] [統計WEB](https://bellcurve.jp/statistics/course/9309.html)
[4] [いちばんやさしい、医療統計](https://best-biostatistics.com/hypo_test/test.html)
[5] [統計学入門](http://www2.econ.tohoku.ac.jp/~isgk/lec_material/basic_stat2022/basic_stat2022_12.pdf)
[6] [うさぎ塾](https://www.momoyama-usagi.com/entry/math-stat-testing#i-4)
[7] [データサイエンスLab.](https://www.youtube.com/watch?v=hhsX0u56X6w)
[8] [なるほど統計学園](https://www.stat.go.jp/naruhodo/11_tokusei/kentei.html)
[9] [Data Driven Knowledgebase SiNCE](https://blog.since2020.jp/data_analysis/data-analysis02/)
[10] [Machine Learning Plus](https://www.machinelearningplus.com/statistics/t-test-students-understanding-the-math-and-how-it-works/)
[11] [スタビジ](https://toukei-lab.com/%E6%A4%9C%E5%AE%9A)
[12] [Staat](https://corvus-window.com/whats_hypothesis-testing/)
[13] [予備校のノリで学ぶ「大人の数学・物理」](https://www.youtube.com/watch?v=4ZHcBtLdOQs)
[14] [たにぐち授業ちゃんねる](https://www.youtube.com/watch?v=XxW7juTPDBs)
...
- 公式ドキュメントを読もう
- 【講義】
  - 公式ドキュメント「関数名/メソッド名 + documentation」
  - 主成分分析
  - 今やっている勉強はここ数年の論文でも使用されている
  - グループワーク「コンビニデータ分析」

## 2023-10-23 第7回 クラスタリング
- 「問題を用意してもらう」から「問題を見つける」へ
- 【講義】
  - アウトプットのすすめ
  - クラスタリング
    - k-means法
...
- ポイント解説は、24時間/日 × 7日 = 168時間 のうちの1.2%です。ほぼ消される欠損値。だからこそ、残りの約99%を自走するのです。
- データ分析は前処理が8割（ソース不明）
- エンジニアが嬉しいデータ形式を知る
- ゴミを入れればゴミが出る　GIGO
- LT会「科学は神を否定するのか」
- 【講義】
  ...
  　- 【Q1】lego.csvが読み込めない
      【A1】エラー文を読みましょう
        読み込み時のデータの状態にかかわらず、読み込めるはず
        エラー文を参考に解決していくと良い
  　- 【Q2-1】欠損値補完はデータ改竄にならないか？
      【A2-1】適切かつ公言していれば、改竄に当たらない！
        ただしリークに気を付ける
        → 未来のデータを使って過去のデータを使うことはさけるべき！
    - 【Q2-2】重複削除と欠損値の処理はどちらが先か？
      【A2-2】欠損値の処理 → 重複削除　が多い
      ルールはない
    - 【Q2-3】どこまでを重複とするべきか
      【A2-3】タスクによる
    - 【Q2-4】表記の揺れはどうしたらいいですか<br>
      【A2-4】まずは表記の揺れが悪か判断<br>
      一つにそろえるのが好ましいが、難しい
    - 【Q3】欠損値が何割くらいなら、行を削除するか？
      【A3】全データの1％未満なら行を削除
  - 前処理
    - 欠損値の補完
      - 平均代入法
      - ホットデック法
      - 機械学習で埋める
      - 欠損値の種類を判別してから埋める（MCAR、MAR,MNAR）
  - 特徴量エンジニアリング
- グループワーク
- [データサイエンティストのための特徴量エンジニアリング](https://book.mynavi.jp/ec/products/detail/id=138750)
- [Kaggleで勝つデータ分析の技術](https://gihyo.jp/book/2019/978-4-297-10843-4)
- [欠測データ処理―Rによる単一代入法と多重代入法―](https://www.kyoritsu-pub.co.jp/book/b10003896.html)
...
- 【講義】
  - Q＆A
    - 【Q1】ハイパーパラメータは、文献の値を引用しても意味がないですか
      【A1】意味がないです。
        ただし、似たデータや、これから学習する分野では最初のパラメータとして使うことがあります。
    - 【Q2-1】グリッドサーチはValデータは使わないの？
      【A2-1】使いません。
      GridSearchCVは交差検証の一部として検証が行われるため
    - 【Q2-2】2回目の検証範囲で、1回目のベスト条件を含まないのは何故？
      【A2-2】同じ組み合わせを2回繰り返さないようにするため
    - 【Q2-3】最も良い結果が3パターンあるうち、どうやって条件を決めたのか？
      【A2-3】スコアが同じなら、より単純なモデルを採用する
  - ハイパラの調整
    - グリッドサーチ
    - ランダムサーチ
    - シーケンシャルモデルベース最適化（SMBO）
  - Oputuna
- グループワーク「これまで3回の振り返り」
- [Optunaによるブラックボックス最適化](https://www.ohmsha.co.jp/book/9784274230103/)
- [Jaak Simm; Survey of hyperparameter optimization in NIPS2014, (2015)](https://github.com/jaak-s/nips2014-survey)
...
- 【講義】
  - Q＆A
    - 【Q1】チーム分けは本当にランダムですか？
      【A1】ランダムにしているはずですが、謎です
    - 【Q2-1】データサイエンス分野で必読な本
      【A2-1】PRML
    - 【Q2-2】データサイエンスの好きなところ
      【A2-2】理論、有限の経験から次の行動を決めるところ。
  - コンペティションに参加
...
- [パターン認識と機械学習](https://www.maruzen-publishing.co.jp/item/b294524.html)
...
- 【講義】
  ...
  - 主体的であれ
- グループワーク「論文を読む」
  - [(PDF) Deep Residual Learning for Image Recognition](https://arxiv.org/pdf/1512.03385.pdf)
  - [(PDF) Going Deeper with Convolutions](https://arxiv.org/pdf/1409.4842.pdf)
  - [(PDF) ImageNet Classification with Deep Convolutional Neural Networks](https://proceedings.neurips.cc/paper_files/paper/2012/file/c399862d3b9d6b76c8436e924a68c45b-Paper.pdf)
  - [(PDF) Very Deep Convolutional Networks for Large-Scale Image Recognition](https://arxiv.org/pdf/1409.1556.pdf)
...
1. 「いろいろ試してみた」毒キノコ、車両予約、かわいい判定、TTS、Q学習、E資格
2. 「きのこ or たけのこ ??」ガラス工房アプリ、日本語解析アプリ、ビスケットの割れ検知、お買い物アプリ
3. 「SHINOBI-忍-」お魚発見アプリ、NARUTO検出アプリ
4. 「株価って予想できるのか？」株価予測アプリ
5. 「黒い三連星 ジェットストリームアタック」ミックスナッツの分類アプリ、コーヒーの焙煎分類アプリ、ポテトチップス分類アプリ
6. 「アボカドとの日々」アボカド食べ頃判定アプリ
7. 「ファッションアイテム分類」ファッションアイテム分類アプリ
8. 「全てAIに頼ってみました」申込者数を増やすための有効な施策を提案
9. 「いつもギリギリで生きている●●のリアル航空会社レビュー分析」航空会社レビューデータ分析
10. 画像診断によるイネの病害識別アプリ
11. 「忘却の彼方・・・」絵画判定アプリ”もねかもね”
